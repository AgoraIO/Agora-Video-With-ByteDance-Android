...
这个开源示例项目演示了如果快速集成 [Agora](www.agora.io) 视频 SDK 和 [ByteDance Effect](https://ailab.bytedance.com/sdk2) 美颜 SDK，实现一对一视频聊天。
...
本项目采用了 ByteDance Effect 提供的视频采集，美颜，本地渲染等视频前处理功能，使用了 Agora 提供的声音采集，编码，传输，解码和远端渲染功能。

ByteDance Effect 美颜功能实现请参考 [ByteDance Effect 官方文档](https://ailab.bytedance.com/sdk2)
...
请联系 sales@agora.io 获取证书文件替换本项目中的 **ByteDance Effect/src/main/java/com/ByteDance Effect/authpack.java**。
...
- 如果发现了示例代码的bug，欢迎提交 [issue](https://github.com/AgoraIO-Community/ByteDance Effect/issues)
